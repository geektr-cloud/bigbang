...
resource "alicloud_security_group_rule" "pokemon_public_ipv4" {
  ...
  security_group_id = alicloud_security_group.pokemon_public.id
...
resource "alicloud_security_group_rule" "pokemon_public_ipv6" {
  for_each = alicloud_security_group_rule.pokemon_public_ipv4
